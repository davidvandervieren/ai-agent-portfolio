...
Ryan Sablich
Building and Code Enforcement Technician
Building in Huerfano
Planning and Zoning
Code Enforcement
FAQ- Building Permits
Online Permitting and Licensing Portal
Huerfano County is using MyGov to manage contractor registrations, permits, and license applications. Now, you can submit applications and participate in projects with the County online. For details on how to use the Collaborator Interface,
click here
. Follow
this link
to create your collaborator account today.
Apply for a Building or Land Use Permit Online
Building in Huerfano County
General Information for Building Permits
Building Permit Guidelines
Building Permit Guidelines Revised January 1st 2024
Adopted and Amended Building Codes
Huerfano County has adopted the codes listed below. Additions, insertions, attachments, deletions and changes are prescribed in Resolution 23-25.
International Building Code “IBC” 2021 edition, including appendix chapters C & F
;
International Residential Code “IRC” 2021 edition, including appendix chapters F, J, R, & S
;
...
;
American National Standard on the design and Construction of Log Structures “ICC 400-2022”
;
...
For access off of a county road, more information can be found
on the Road and Bridge page
. Access permits can be applied for through the permitting portal
For access off of a state highway, please look
on the CDOT website in the business center
.
Residential Submittal Requirements
The following submittals are required with all building permit applications. Those from section 106 of the 2021 IRC reflect amended changes from and additions to the IRC 2021 edition as adopted as the Huerfano County Building Code in Resolution 23-25. Details on construction documents can be found in section 106 of the 2021 IRC; items 106.1.5 through 106.1.12 were added by Resolution 23-25.
106.1.5 Building Permit Application.
Applications can be made on forms provided by the Building Inspector or online here:
https://co-huerfano-co.smartgovcommunity.com/Public/Home
106.1.1 Construction documents.
Construction documents may be submitted electronically and shall be of sufficient clarity to indicate the location, nature and extent of the work proposed and show in detail that it will conform to provisions of this code and relevant laws, ordinances and regulations.
Construction Documents to include:
1.
106.1.9 Exterior elevations.
Show each view. Show vertical dimensions and heights. Show openings, identify materials and show lateral bracing system, where applicable. Show dimensions and schedules.
2.
106.1.10 Foundation plan.
Show all foundations and footings. Indicate size, locations, thickness, materials and strengths, and reinforcing. Show all imbedded anchoring such as anchor bolts, hold-downs, post bases, etc. Show dimensions for the location and size of all components delineated on the foundation plan. Each set of foundation plans shall meet the requirements of the Huerfano County Board of Commissioners’ Resolution No. 09-16.
...
3.
106.1.11 Floor plan.
Show all floors including basements. Show all rooms, with their use. Overall dimensions and location of all structural elements and openings. Show all doors and windows. Provide door and window schedules. All fire-resistance-rated assemblies, areas of refuge, occupancy separations, fire blocking and draft stopping shall be shown. Show dimensions for the size of all rooms and the locations of other components delineated on the floor plans.
4.
106.1.12 Framing plan.
Show all structural and non-structural members, their size, methods and details of attachment, connections, location and materials for floor, roof, decks and wall section. When required by this code show all fire-rated assemblies and fire-resistant penetrations.
5.
Mechanical plan.
Show all structural and non-structural members, their size, manufactured specifications of the unit, methods and details of attachment, connections, location and materials.
Note: A fireplace is considered a secondary source of heat. “NOT” a primary.
6.
Engineered Truss plan.
Slope or depth, span & spacing, location of all joints, require bearing widths design loads as application (Top chord live load, Top chord dead load, Bottom chord live load, Bottom chord dead load, concentrated loads and their points of application, controlling wind and earthquake loads). Adjustment to lumber and joint connector design values for conditions of use. Each reaction force and direction joint connector type and description and the dimensioned location of each joint connector except where symmetrically located relative to the joint interface, lumber size, species and grade for each member, connection required for truss-to-truss girder, truss ply-to-ply, field splice, calculated deflection ratio and/or maximum description of for live and total load. Maximum axial compression ratio forces in the truss members to enable the building designer to design the size, connections, and anchorage of the permanent continuous lateral bracing forces shall be shown on the truss drawings or on supplemental documents, required permanent truss member bracing location.
...
106.1.3 Information on braced wall design.
For buildings and structures utilizing braced wall design, and where required by the building official, braced wall lines shall be identified on the construction documents. Pertinent information including, but not limited to, bracing methods, location and length of braced wall panels and foundation requirements of braced wall panels at the top and bottom shall be provided.
106.1.3 Information for construction in flood hazard areas. (see R106.1.3 and Section 4.00 of the Land Use Code for details)
106.2 Site Plan or Plot Plan
The construction documents submitted for the application for permit shall be accompanied by a site plan.
The site plan shall include the following items:
1. In all zoning districts (with the exception of agricultural) a site improvement survey, sealed by a Colorado Registered Land Surveyor is required in addition to items two (2) through ten (10). At the discretion of the Land Use Director, this requirement may be waived.
2. A legible map, drawn to scale, as accepted by the Building Inspector, showing the location, height and approximate dimensions or envelope location of each existing and proposed structure, and a description of the uses to be contained within each existing and proposed structure.
3. The existing and proposed building setbacks and the building area showing distance to property lines, highway, street or road rights-of-way, watercourses, and other natural and historic features of the site.
...
7. The location of any easements on the property, including type of easement.
8. The anticipated location of all water, sewage disposal, electrical, telephone, and other utilities.
9. All finished grading and stormwater runoff.
10. Vicinity map – Map showing the location of the proposed site in relationship to the surrounding area within 500 feet of the boundaries.
106.1.6 and 106.1.7 Sanitation & Water.
Pursuant to C.R.S. §25-10-112 (1) and section 10.05 of the Huerfano County Land Use Code the applicant must show proof of an approved sanitation system. Pursuant to the Board of County Commissioners Resolution No: 21-22, proof of adequate water is required in order to obtain a building permit.
106.1.8 Right to develop.
Applicant must show a deed or other proof of property ownership. If the applicant is other than the property owner, they must hold a Huerfano County Contractor license that is appropriate for the type of construction being permitted and have written authorization to act as the owner’s agent. Proof of ownership must include a complete property description, unless otherwise approved by the building inspector.
Owner-Liability
– Property owners submitting owner-build permits must sign a letter of understanding from the Huerfano County Building Authority board, relevant to the use of subcontractors.
...
Apply for a Contractors License Online
Required Items for a Contractor License:
...
New application fee.
A non-refundable Application Fee of $100.00 is required at the time of submission.
Renewal fee.
A non-refundable Renewal Fee of $25.00 is required when a license is renewed. After the 90-day renewal grace period has expired renewals must pay the full new application fee.
License Fee:
$100 per jurisdiction
...
Contractor License Types and Requirements
...
Licensed Contractors-B
Licensed Contractors-C
Licensed Contractors-D
Planning and Zoning
Development in Huerfano County is guided by the Comprehensive Plan, adopted in 2025, and the Zoning Regulations and Procedures. Below there is a link to the Comprehensive Plan itself as well as a folder containing the Comprehensive Plan and supporting materials.
Land Use Regulations and Procedures
Marijuana Licensing Regulations
2025 Comprehensive Plan and Supporting Materials
Land Use Applications Received by Year
...
If you are interested in changing the name of a Road that process is illustrated in
Resolution 14-04
Burn Permits: Controlled burns require a burn permit which can be applied for on the permitting portal.
Apply for a Marijuana License Online
Code Enforcement
...
Anonymous complaints will be accepted, but may or may not be investigated at the discretion of the Land Use and Building Department depending on the following factors:

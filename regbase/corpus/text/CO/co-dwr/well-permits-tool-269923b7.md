...
Export: Well Permits
Spreadsheets
List of selected well permits with metadata
Record count:
0
Export to CSV
Cancel
...
NA
See Associated Receipts
Dry Hole Constructed
Dry Hole Abandoned
Pump Installed in Well Without a Permit
Post Construction Review Requested
Pump Installed, No Construction Info Received
Final Permit
Final Permit - Replacement Permit Issued
Final Permit - Well Replaced, Abandonment Required
Final Permit - Well Replaced
Final Permit Canceled
Permit Expired (Pump Installed)
Well Deepened
Final Permit - Well Deepened
Permitted Use
All
Irrigation
Municipal
...
WDID
Well Name
Click 'Select' to see additional search options
Address
Within
Miles
Feet
...
Hydrogeology Review Completed
Well Inspected, Key Phase
Well Inspected, Routine
Dry Hole Constructed
Amended Final Permit Issued
Between
and
Equals
Starts With
...
Permit Category
Permit Issued
Date 1st Beneficial Use
Date Permit Expires
Construction Date
Last Pump Install Date
Date Well Plugged
Aquifer(s)
Use(s)
Elevation
...
items per page
No items to display
If you know your permit number:
1. Do not touch the top four items, so they still say 'All'.
2. Click the word 'Select', just above the bouncing arrow.
3. From the dropdown list, click 'Permit Number'.
4. Type your permit number, numbers only, in the 'From' box.
5. Leave 'To', 'Suffix', and 'Replacement' blank.
Click Search. Then click 'View' beside permit in the results table.
Your search returned no results.
Please change your search criteria and try again.
You can refresh this page and start over by clicking "Well Permits" above the Search Fields.
×
Error:
Close
×
About Well Permits
Description
Division of Water Resources (DWR) Well Permit dataset. Detailed reports about well applications and permits with links to related imaged documents. Search by permit number, address, subdivision, or other criteria to pinpoint the well of interest.
Resources
User Guide
Data Dictionary (Well Permits)
Ask DWR: Other Questions About Well Permits

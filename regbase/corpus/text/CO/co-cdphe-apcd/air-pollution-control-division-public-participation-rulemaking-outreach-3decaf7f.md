...
Español
Jump to : Upcoming public participation opportunities | Public Meetings | Open public comment periods | Meeting accommodation notice | Current projects | Get involved: Air permit public notices | More ways to engage with the state of Colorado | Colorado air quality regulation updates | Steps of the rulemaking process and 101 resources | Stay informed | Contact us

<!-- heading-path: Upcoming public participation opportunities -->
...
<!-- heading-path: Upcoming public participation opportunities > Public meetings -->
## Public meetings
...
<!-- heading-path: Upcoming public participation opportunities > Open public comment periods > Supplemental Fuel Other Test Method (OTM) 52 testing protocol -->
### Supplemental Fuel Other Test Method (OTM) 52 testing protocol
The division has proposed a Supplemental Fuel OTM 52 Testing Protocol. The draft protocol addresses challenges for completing testing on low or intermittent-flow enclosed combustion devices that control storage tanks. The protocol will provide options for facilities that may not be able to sustain consistent waste gas flow without supplemental fuel.
Refer to the draft protocol.
The division will accept feedback on the draft protocol through August 28, 2026. Submit comments to cdphe.commentsapcd@state.co.us with the subject line “OTM Supplemental Fuel Protocol.”
For tips on offering feedback, review 10 tips for making effective public comments.

<!-- heading-path: Upcoming public participation opportunities > Open public comment periods > Clean Energy Plan (CEP) Hardship Letters: Share your feedback -->
### Clean Energy Plan (CEP) Hardship Letters: Share your feedback
The division has received letters from three electric utilities: CORE, Colorado Springs Utilities (CSU), and Municipal Energy Agency of Nebraska (MEAN), noting potential challenges each utility is facing in meeting the 80% GHG reduction in its previously verified CEP.
A copy of the letter submitted by each utility is provided below.
...
<!-- heading-path: Upcoming public participation opportunities > Current projects -->
## Current projects

<!-- heading-path: Upcoming public participation opportunities > Current projects > Environmental Justice Summary Dashboard -->
...
<!-- heading-path: Upcoming public participation opportunities > Current projects > Air permits open for public comment -->
...
<!-- heading-path: Upcoming public participation opportunities > Current projects > Annual air quality enforcement report -->
### Annual air quality enforcement report
The division released a new annual enforcement report in January 2026 as well as a supplemental report summary . The annual report covers enforcement actions, penalties and trends between October 2024 and September 2025. It builds on the information previously summarized in the division’s federal fiscal year 2024 annual report and December 2024 five-year benchmark report . Learn more about the division’s enforcement reporting on the settlements and orders web page .

<!-- heading-path: Upcoming public participation opportunities > Current projects > Stationary Source Control Fund -->
### Stationary Source Control Fund
The Stationary Source Control Fund supports the air division’s work to manage and reduce air pollution. Stationary sources of air pollution pay into the fund through fees. The air division engages with stakeholders and the public, including stationary sources, about how the fund is used. The division’s engagement focuses on potential process improvements supported by the fund. For more information about the fund, meeting dates, and how to register, visit the Stationary Source Control Fund web page .

<!-- heading-path: Upcoming public participation opportunities > Get involved: Air permit public notices -->
...
<!-- heading-path: Upcoming public participation opportunities > More ways to engage with the state of Colorado -->
...
<!-- heading-path: Upcoming public participation opportunities > Colorado air quality regulation updates -->
...
<!-- heading-path: Upcoming public participation opportunities > Colorado air quality regulation updates > Upcoming regulatory concepts or proposed changes to existing Colorado air quality regulations include: -->
### Upcoming regulatory concepts or proposed changes to existing Colorado air quality regulations include:
Proposed updates include: Revisions to reduce duplicative emissions reporting requirements. Revisions to fees associated with APEN submittals, permit processing, annual criteria pollutant emissions, annual hazardous air pollution emissions, and potentially other application materials submitted to the division.
...
Regulatory concepts: Rulemaking concepts . Rulemaking concepts regulation 3 . Rulemaking concepts regulation 7 .
Rulemaking concepts .
Rulemaking concepts regulation 3 .
Rulemaking concepts regulation 7 .
Hearing date: Feb 18-19, 2027
Questions or comments? Email cdphe.aqcc@state.co.us before the hearing date above.

<!-- heading-path: Upcoming public participation opportunities > Steps of the rulemaking process and 101 resources -->
## Steps of the rulemaking process and 101 resources
We provide resources to make the rulemaking process easier to understand. There are seven steps that must happen before the air division is responsible for enforcing the regulation.
Learn more about the process on our web page.

<!-- heading-path: Upcoming public participation opportunities > Stay informed -->
## Stay informed
...
<!-- heading-path: Upcoming public participation opportunities > Contact us -->
## Contact us

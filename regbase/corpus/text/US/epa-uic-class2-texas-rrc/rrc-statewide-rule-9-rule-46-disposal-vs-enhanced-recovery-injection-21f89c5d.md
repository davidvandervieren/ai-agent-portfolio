...
title: RRC Statewide Rule 9 / Rule 46 (disposal vs. enhanced recovery injection)
doc_type: regulation
citation_root: 16 TAC (Statewide Rules 9, 46, 95, 96, 97)
url: "https://www.rrc.texas.gov/oil-and-gas/applications-and-permits/injection-storage-permits/oil-and-gas-waste-disposal/injection-disposal-permit-procedures/technical-review"
sha256: 48ded613524163b682766e68a838abeba25ecb2e938572a4e7ccf5668fb038a2
fetched_at: "2026-09-05T05:11:17+00:00"
---

<!-- heading-path: Technical Review -->
# Technical Review
...
Permit Restrictions by Geography and Geology
Surface Casing
Production Casing
Packer Depth
Geologic Isolation
...
<!-- heading-path: Technical Review > Surface Casing -->
### Surface Casing
...
<!-- heading-path: Technical Review > Surface Casing > Production Casing -->
### Production Casing
...
The production casing must be cemented immediately above the injection/disposal interval with at least: 600 feet of cement based on cement volume calculations, 250 feet of cement verified by a temperature survey conducted at the time of cementing, or 100 feet of cement verified by a cement bond log that shows the cement is well bonded to the pipe and formation (80% bond or higher) with no indication of channeling; or
...
<!-- heading-path: Technical Review > Surface Casing > Packer Depth -->
### Packer Depth
...
<!-- heading-path: Technical Review > Surface Casing > Geologic Isolation -->
### Geologic Isolation
...
<!-- heading-path: Technical Review > Surface Casing > Area of Review (AOR) -->
### Area of Review (AOR)
...
<!-- heading-path: Technical Review > Surface Casing > Injection Pressure -->
### Injection Pressure
...
<!-- heading-path: Technical Review > Surface Casing > Injection Fluids -->
### Injection Fluids
...
<!-- heading-path: Technical Review > Surface Casing > Commercial Facilities -->
### Commercial Facilities
...
<!-- heading-path: Technical Review > Surface Casing > Dual Completion Wells -->
### Dual Completion Wells
...
Pull the tubing and packer string(s) from the well. Set a temporary plug within 100 feet of the injection perforations. Run a test packer on tubing and set it just below the productive perforations. Perform a standard H-5 pressure test of the casing between the test packer and temporary plug (above perforations). Reset the test packer just above the productive perforations. Perform a standard H-5 pressure test of the annulus to test the casing from the test packer to the wellhead. Pull the tubing, test packer, and temporary plug, and then reset the injection string. Perform a radioactive tracer survey through the injection string to demonstrate tubing integrity and packer seal. File the Pressure Test Reports (Forms H-5) for each of the three parts of the mechanical integrity test.
Pull the tubing and packer string(s) from the well.
Set a temporary plug within 100 feet of the injection perforations.
Run a test packer on tubing and set it just below the productive perforations.
Perform a standard H-5 pressure test of the casing between the test packer and temporary plug (above perforations).
Reset the test packer just above the productive perforations.
Perform a standard H-5 pressure test of the annulus to test the casing from the test packer to the wellhead.
Pull the tubing, test packer, and temporary plug, and then reset the injection string.
Perform a radioactive tracer survey through the injection string to demonstrate tubing integrity and packer seal.
File the Pressure Test Reports (Forms H-5) for each of the three parts of the mechanical integrity test.

<!-- heading-path: Technical Review > Surface Casing > Horizontal Injection Wells -->
### Horizontal Injection Wells
...
<!-- heading-path: Technical Review > Surface Casing > Rule Exceptions -->
### Rule Exceptions
...
<!-- heading-path: Technical Review > Surface Casing > Packer Depth Exception -->
...
<!-- heading-path: Technical Review > Surface Casing > Pressure Observation Valve Exception -->
...
<!-- heading-path: Technical Review > Surface Casing > Engineering and Geological Studies -->
### Engineering and Geological Studies
